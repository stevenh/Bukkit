...
public interface PluginLoader {
     ...
     * @throws InvalidDescriptionException Thrown when the plugin doesn't contain a valid description file
     */
     ...
     *
     * @param file File to attempt to load
     * @param checkDependencies Loader will not check dependencies if this flag is set to true
     * @return Plugin that was contained in the specified file, or null if unsuccessful
     * @throws InvalidPluginException Thrown when the specified file is not a plugin
     * @throws InvalidDescriptionException Thrown when the plugin doesn't contain a valid description file
     */
    ...
    /**
     * Loads the plugin description file contained in the specified file
     *
     * @param file File to attempt to load the description file from
     * @return PluginDescriptionFile that was contained in the specified file, or null if unsuccessful
     * @throws InvalidPluginException Thrown when the specified file is not a plugin
     * @throws InvalidDescriptionException Thrown when the plugin doesn't contain a valid description file
     */
